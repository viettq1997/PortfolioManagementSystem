...
public interface AuditRepository extends JpaRepository<Audit , String> {
    ...
    String auditQuery = "select a.transaction_ref as transactionRef, a.instrument_id as instrumentId, a.trade_type as tradeType, a.audit_date as auditDate ,i.instrument_name as instrumentName from audit a, instrument i where a.portfolio_id = ?1 and a.instrument_id = i.id";
